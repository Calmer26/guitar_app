 ...
 * 
 * Usage:
 *   node src/tests/diagnostic/pipeline-check.test.js
 *   node src/tests/diagnostic/pipeline-check.test.js --ground-truth --min-score 95
 */

// Import required modules (using CommonJS for Node.js compatibility)
const fs = require('fs');
...
// Load analyzer module (will need to be adapted for Node.js)
console.log('🔧 Pipeline Diagnostic Test Starting...\n');
